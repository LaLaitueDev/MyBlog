...
const ERROR_PASSWORD_TOO_SHORT = 'Le mot de passe est trop court. 6 caractère minimum.';
const ERROR_WRONG_PASSWORD = 'Les mots de passe ne sont pas identiques !';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$confirmpassword) {
        ...
        $errors['confirmpassword'] = ERROR_WRONG_PASSWORD;
    }
